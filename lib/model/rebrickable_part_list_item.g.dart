...
RebrickablePartListItem _$RebrickablePartListItemFromJson(
        Map<String, dynamic> json) =>
    RebrickablePartListItem(
...
Map<String, dynamic> _$RebrickablePartListItemToJson(
        RebrickablePartListItem instance) =>
    <String, dynamic>{
